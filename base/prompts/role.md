...
(This is the default role prompt. At install time the selected role part — coach, guide, trainer, or schemer — overrides this file; it only applies when no role was selected.)
