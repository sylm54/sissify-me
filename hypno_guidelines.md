...
To keep the user in trance a few redeepening subscripts should be interspersed throughout the main segment to maintain the user's trance state and enhance the effectiveness of the suggestions being made. These should contain general suggestions of relaxation, focus, and receptivity.
